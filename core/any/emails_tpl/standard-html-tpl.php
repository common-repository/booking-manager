 ...
 */
function wpbm_email_template_standard_html( $fields_values ) {
    ob_start();
                            ...
                            <tr>
                                <td class="inner">              <!-- <?php echo ( wp_kses_post( wptexturize( $fields_values['footer_content'] ) ) );  ?> -->
                                    <p>
                                        ...
                                        You are receiving this email because you are either purchased product at WPBM or you entered your email at WPBM
                                    </p>
                                </td>
                            </tr>
                        </table>
