...
abstract class WPBM_Emails_API extends WPBM_Settings_API  {
...
//debuge( $wp_error_object );
        if ( $this->sending ) {                                                 // Check  if this error generated for email relative to  this class.
            ...
            if ( ! empty( $error_description_array ) ) {
                ...
                do_action('wpbm_email_sending_error', $wp_error_object, $error_description );

            } else {
                do_action('wpbm_email_sending_error', $wp_error_object, '' );
            }
        }        
    }
